    ...
    # function that takes two lists and returns a list with the indicies which are the same between the two lists
    def same_zees(lst1, lst2):
        same = []
    ...
    print(same_zees([1, 2, 34, 5, 23, 7], [1, 2, 3, 4, 5, 6, 7]))
    print(saem([1, 2, 3], [3, 2, 1]))
